...
export const CardConocerMas = ({ imagen, titulo, p1, p2 }: CardConocerMasProps) => {
    return (
        <>
            <div className="col-span-1   p-4 sm:p-2 lg:p-0   text-center  ">
                ...
                <div className='text-center lg:px-0 '>
                    ...
                    <p className="sm:text-sm md:text-sm xl:text-xl text-gray-600 montserrat mt-2 lora text-justify md:text-justify  lg:mx-auto sm:px-2 xl:px-[2%]  lg:py-4  min-[590px]:max-w-[490px] min-[590px]:mx-auto xl:max-w-[520px] 2xl:max-w-[545px] xl:mx-auto ">{p1} </p>
