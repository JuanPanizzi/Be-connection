...
export const BeInfo = () => {
    return (
        <article className="xl:max-w-[1700px] mx-auto" id='be-info'>
            <section className="mx-auto  grid grid-cols-1 sm:grid-cols-2 sm:gap-4 sm:py-6 sm:gap-8">
                <div className="mx-auto  flex flex-col justify-center px-10 sm:px-0 pt-10 sm:pt-0 pb-2 sm:pb-0 sm:px-10 xl:px-0 bg-red-200  ">
                    <h1 className="text-center sm:text-left  text-3xl   lg:text-6xl xl:text-7xl">SOBRE BE!</h1> 
                    <h2 className="text-center sm:text-left text-lg text-purple1 lg:text-[2rem] xl:text-[2.5rem] my-4  sm:my-6">DE QUÉ SE TRATA BE CONNECTIONS</h2>
                ...
                <div className="flex justify-center xl:justify-end  items-center p-4 sm:p-6 lg:p-8 rounded-lg xl:p-0 ">
                    <img
                        src={beInfo1}
                        alt="beConnections"
