...
export const NewsLetterInfo = () => {
  return (
    <>
<article className=' xl:max-w-[2000px] mx-auto xl:px-20 flex flex-col-reverse lg:flex-row lg:pt-10'>
    ...
    <div className='  lg:w-[40%] mt-7 lg:mt-0 md:mt-4 py-3 '>
        <img src={rose} alt="rose" className='max-w-[190px] md:max-w-[250px] lg:max-w-[450px] xl:max-w-[480px] lg:px-0  lg:py-0 object-left mx-auto  object-contain lg:object-fill rounded  rounded-t-[40%] lg:rounded-t-[40%] lg:mt-10 bg-lime-200' />
    </div>
